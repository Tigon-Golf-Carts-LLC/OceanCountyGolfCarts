...
export default function EvolutionClassic4Plus() {
  return (
    <>
      <SEOHead 
        title="EVOLUTION® CLASSIC 4 PLUS"
        description="Experience the EVOLUTION® CLASSIC 4 PLUS with timeless design and modern electric performance. Call 1-844-844-6638."
