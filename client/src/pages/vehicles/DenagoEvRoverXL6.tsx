  ...
  return (
    <>
      <SEOHead 
        ...
        description="Experience the DENAGO® EV Rover XL6 with premium luxury features and 6-passenger seating. Call 1-844-844-6638."
        keywords="DENAGO EV Rover XL6, luxury electric vehicle, 6-passenger golf cart, premium comfort, DENAGO dealer Ocean County"
        ogImage="/attached_assets/DENAGONEVROVERXL6_1751893047473_1753135231313.jpg"
      />
